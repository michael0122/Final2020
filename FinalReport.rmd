...
basicC <- ggplot(Guys,aes(x=treatment,y=count,fill=infected))
...
here it's shown that the p-value is such a tiny number which is 0.0006181 hen we will reject the null hypothesis because it shows that there is no difference between the guys who have taken the vaccine and the guys who havn't in terms of contracting the covid. 
